...
public class ObsoleteAvroizeFile
{
  public static void main(String[] args)
  {
    String[] sa = App.getPaths(args,2);
    new ObsoleteAvroizeFile().avroIzeFile(sa[0], sa[1], null);
  }

  private int sparkPartitionSize = SAMPLE_SPLIT_SIZE;

  public void avroIzeFile(String inputPath, String outputPath, Integer partitionSize)
  {
    ...
    if(partitionSize != null)
      sparkPartitionSize = partitionSize;

    System.out.println("AvroizeFile: input: "+inputPath+" output: "+outputPath+" partition size: "+sparkPartitionSize);
