 ...
 */
public class SparkReadAvro127M extends SparkReadAvroBase
{
 public static void main(String[] args)
  {
    String[] sa = App.getPaths(args, 1);
    new SparkReadAvro127M(sa[0]);
  }
 
  private BEAvroMetaData metadata;

  public SparkReadAvro127M(String path)
  {
    super(path);
  }
  ...
  protected void init(String path)
  {
    try {
      ...
      DatumReader<DiskImageSplit127M> diDatumReader = new SpecificDatumReader<>(DiskImageSplit127M.class);
      DataFileReader<DiskImageSplit127M> dfr = new DataFileReader<>(fileData[INP].inputFsInput, diDatumReader);
  ...
  {
    return AvroUtils.toSchema(DiskImageSplit127M.class.getName());
  }
