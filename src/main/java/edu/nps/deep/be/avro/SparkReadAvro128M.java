 ...
 */
public class SparkReadAvro128M extends SparkReadAvroBase
{
 public static void main(String[] args)
  {
    String[] sa = App.getPaths(args, 1);
    new SparkReadAvro128M(sa[0]);
  }

  private BEAvroMetaData metadata;

  public SparkReadAvro128M(String path)
  {
    super(path);
  }
  ...
  protected void init(String path)
  {
    try {
      ...
      DataFileReader<DiskImageSplit> dfr = new DataFileReader<>(fileData[INP].inputFsInput, diDatumReader);
  ...
  {
    return AvroUtils.toSchema(DiskImageSplit.class.getName());
  }
